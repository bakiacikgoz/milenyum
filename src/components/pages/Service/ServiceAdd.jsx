        ...
        <div className="lg:container lg:py-4 lg:mx-auto">
          ...
          <div className="flex flex-wrap">
              <div className="w-full w-12/12 pt-4">
                <button href="#" className="text-white bg-slate-700 hover:bg-slate-800 focus:ring-4 focus:ring-slate-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-slate-600 dark:hover:bg-slate-700 focus:outline-none dark:focus:ring-slate-800">Hizmet Ekle</button>                
              </div>
          </div>
        </div>
      </div> 
