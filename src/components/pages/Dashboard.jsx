      ...
      <div className="max-w-7x1 mx-auto">
          <div className="flex flex-wrap ">
            <div className="w-full lg:w-2/12">
                <div className="flex flex-wrap bg-slate-500 text-white rounded p-3 hover:bg-slate-600 cursor-pointer shadow-lg font-thin dark:bg-slate-800  dark:hover:bg-slate-700 ">
