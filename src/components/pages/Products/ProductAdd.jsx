        ...
        <div className="lg:container lg:py-4 lg:mx-auto">
          ...
          <div className="flex flex-wrap">
            ...
            <form class="w-full mx-auto">
                ...
                <select
                  ...
                  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                >
                  <option selected>Bir tip seç</option>
                  <option value="US">United States</option>
                  <option value="CA">Canada</option>
                  <option value="FR">France</option>
                  <option value="DE">Germany</option>
          ...
          <div className="flex flex-wrap">
            ...
            <div className="w-full w-12/12 lg:w-12/12 p-1 pt-5">
              <label
                htmlFor=""
                className="text-gray-900 dark:text-white font-medium text-sm block mb-2"
              >
                Ürün özellikleri
              </label>
              <RichTextEditor
                ...
                >
                  <div class="flex flex-col items-center justify-center pt-5 pb-6">
                    ...
                    <p className="mb-2 text-sm text-gray-500 dark:text-gray-400">
                      <span class="font-semibold">Tıkla ve yükle</span> veya da
                      sürükle bırak!
                    </p>
